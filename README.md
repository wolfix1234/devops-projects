...
پروژه شاخص من، پلتفرم تولید سایت (https://wolfixsite.shop) است که در آن به تنهایی تمام زنجیره‌ی DevOps، CI/CD، IaC، امنیت و بخشی از Backend را مدیریت کردم.  
...
- **لینک‌ها:**
  - سایت اصلی: https://wolfixsite.shop  
